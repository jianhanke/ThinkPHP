...
<div class="table-box">
    <table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dat): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="now_borrow"><?php echo ($dat["user_name"]); ?> </td>
                <td class="haved_borrow"><?php echo ($dat["haved_borrow"]); ?> </td>
                <td class="remark" ><?php echo ($dat["remark"]); ?>  </td>
                <td> <a href= "/index.php/Admin/Manage/modify/id/<?php echo ($dat["id"]); ?>"  style="color:#00FF00;font-size:20px;">修改</a>  </td>
