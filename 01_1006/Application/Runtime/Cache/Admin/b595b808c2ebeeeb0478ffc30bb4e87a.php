...
<div id="container">
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        <div class="welcome ue-clear"><span>欢迎您,</span><a href="/Public/Admin/javascript:;" class="user-name"><?php echo (session('username')); ?> </a></div>
        <div class="login-msg ue-clear">
         <a href="<?php echo U('Email/recBox');?> " target="iframe" class="msg-txt">消息</a>
        <a href="<?php echo U('Email/recBox');?> "  target="iframe" class="msg-num">无</a> </div>
      </div>
  ...
  <div id="bd">
    <div class="wrap ue-clear">
        ...
        <ul class="nav">
          ...
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>知识管理</span><i class="icon"></i></a></div>
             <ul class="subnav">
            <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Knowledge/showList');?> ">知识列表</a></li>
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Knowledge/add');?> ">添加知识</a></li>
              </ul>
          </li>
          ...
          <li class="agency">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>组织结构</span><i class="icon"></i></a></div>
               <ul class="subnav">
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Dept/showList');?> ">部门列表</a></li>
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Dept/add');?> ">添加列表</a></li>
          ...
          <li class="email">
            <div class="nav-header"><a href="/Public/Admin/javascript:;" class="ue-clear"><span>邮件管理</span><i class="icon"></i></a></div>
              <ul class="subnav">
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Email/send');?> ">发邮件</a></li>
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Email/sendBox');?> ">发件箱</a></li>
              <li><a href="/Public/Admin/javascript:;" date-src="<?php echo U('Email/recBox');?> ">收件箱</a></li>
            </ul>
          </li>
      ...
      <div class="content">
        <iframe src="<?php echo U('home');?> " id="iframe" width="100%" height="100%" frameborder="0" name="iframe"></iframe>
      </div>
    </div>
  </div>
