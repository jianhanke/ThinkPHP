...
<div class="table-box">
	<table>
        ...
        <?php if(is_array($datas)): $i = 0; $__LIST__ = $datas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="nickname"><?php echo ($data['nickname']); ?> </td>
                <td class="dept_id"><?php echo ($data['dept_id']); ?> </td>
				<td class="sex"><?php echo ($data["sex"]); ?> </td>
				<td class="birthday"><?php echo ($data["birthday"]); ?></td>
                <td class="tel"> <?php echo ($data["tel"]); ?></td>
				<td class="email"><?php echo ($data["email"]); ?> </td>
                <td class="addtime"><?php echo ($data['addtime']); ?> </td>
