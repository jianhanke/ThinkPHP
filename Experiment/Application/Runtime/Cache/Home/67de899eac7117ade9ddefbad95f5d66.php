...
<body>  
    ...
    <div class="leftDiv"  style="height: 100%;width: 34%; float: left; "  >
        ...
        <div class="box" style="height: 90%; width: 100%; " >
            ...
            <div class="con1">
                <video src="/Experiment/Public/Video/<?php echo ($datas['video']); ?>" style="width: 100%;"  controls="" ></video>
            </div>
            ...
            <div class="con2" style="height: 90%;" >
                <form action="<?php echo U('NoVNC/saveNote');?> " id="myForm" method="post"  style="height: 80%;"  target="hidden_iframe"  >
                  ...
                  <input type1="hidden"  name="id" value="<?php echo ($id); ?>" >
            ...
            <iframe src="/Experiment/Public/Htm/<?php echo ($datas['doc']); ?>" frameBorder=0  style="height: 100%;width: 100%; "  ></iframe>
