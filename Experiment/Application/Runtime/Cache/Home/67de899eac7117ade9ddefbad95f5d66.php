...
<body>  
    ...
    <div class="leftDiv"  style="height: 100%;width: 34%; float: left; "  >
        ...
        <div class="box" style="height: 90%; width: 100%; " >
            ...
            <div class="con1">
                <video src="/Experiment/Public/Video/1.mp4" style="width: 100%;"  controls="" ></video>
            </div>

            <div class="con2" style="height: 90%;" >
                  <div id="container"  style="height: 90%;" scrolling="yes"  > </div>
                  <!-- <button>保存</button> -->
            </div>
            <div class="con3" style="height: 100%;width: 100%; " >
                <iframe src="/Experiment/Public/Doc/1.htm" frameBorder=0  width="100%" height="100%"  ></iframe>
            </div>
...
<script type="text/javascript" src="/Experiment/Public/Home/js/Ueditor/ueditor.config.js"></script>
                        ...
                        <script type="text/javascript">
                            var ue = UE.getEditor('container',{toolbars: [
                              ['fullscreen',  ],
                              ['bold', 'italic', 'underline',   'removeformat', 'formatmatch', 'autotypeset',   'forecolor', ]
                          ]} );
</script>