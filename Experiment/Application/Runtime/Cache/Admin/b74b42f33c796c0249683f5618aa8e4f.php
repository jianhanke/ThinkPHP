                ...
                <form action="/Experiment/index.php/Admin/Experiment/modifyExperimentById " method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <input hidden name="Eid" value="<?php echo ($datas['eid']); ?> " > 
                          <!--   <tr>
                                <th><i class="require-red">*</i>实验id:</th>
                                <!-- <th><i class="require-red">*</i>年龄：</th> -->
                               <!--  <td>
                                    <input class="common-text required" name="Eid" size="12" value="<?php echo ($datas['eid']); ?>" type="text">
                                </td> -->
                            </tr> -->
                            ...
                            <tr>
                                ...
                                <!-- <th><i class="require-red">*</i>年龄：</th> -->
                                <td>
                                    <input class="common-text required" name="Ename" size="12" value="<?php echo ($datas['ename']); ?>" type="text">
                                </td>
                            </tr>
                          ...
                          <!--   <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="goal" size="12" value="<?php echo ($datas['goal']); ?>" type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>理论:</th>
                                <td><input class="common-text" name="theory" size="12" value="<?php echo ($datas['theory']); ?>" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>环境:</th>
                                <td><input class="common-text" name="environment" size="12" value="<?php echo ($datas['environment']); ?>" type="text"></td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>所需镜像Id:</th>
                                <td><input class="common-text" name="image_id" size="12" value="<?php echo ($datas['image_id']); ?>" type="text"></td>
                            </tr>
                          <!--    <tr>
                                <th><i class="require-red">*</i>所需镜像Id:</th>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="outcome_model" size="12" value="<?php echo ($datas['outcome_model']); ?>" type="text"></td>
                            </tr>
